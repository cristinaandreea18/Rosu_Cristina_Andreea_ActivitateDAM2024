...
private List<Prajitura> prajituri = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        List<String> prajituriFav = new ArrayList<>();
        for(Map.Entry<String,String>obj:dictionar.entrySet()){
            prajituriFav.add(obj.getValue());
        }

        ListView lv = findViewById(R.id.idLVSharedPreferences);
        ArrayAdapter<String> adapter = new ArrayAdapter<>(getApplicationContext(),android.R.layout.simple_list_item_1,prajituriFav);
